...
class DMDFrame
{
 ...
 public:
  ...
  inline void clearScreen() { fillScreen(true); }; //inverse
...
public:
  ...
  */
  ...
  inline void setBrightness(uint32_t level) { this->brightness = level; };
  inline void setColor(String War) { this->warna = War; };
protected:
...
public:
  DMD_TextBox(DMDFrame &dmd, int left = 0, int top = 0, int width = 0, int height = 0, bool inv = false);
